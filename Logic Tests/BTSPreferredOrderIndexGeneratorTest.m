...
- (void)testGenerateFromDate_January_1_2010
{
    ...
    STAssertEquals(201001010000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}
...
- (void)testGenerateFromDate_January_9_2010
{
    ...
    STAssertEquals(201001090000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_January_10_2010
{
    NSDate *date = BTSCreateDate(2010, 1, 10);
    STAssertEquals(201001100000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_January_11_2010
{
    NSDate *date = BTSCreateDate(2010, 1, 11);
    STAssertEquals(201001110000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_October_9_2010
{
    NSDate *date = BTSCreateDate(2010, 10, 9);
    STAssertEquals(201010090000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_October_10_2010
{
    NSDate *date = BTSCreateDate(2010, 10, 10);
    STAssertEquals(201010100000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_October_11_2010
{
    NSDate *date = BTSCreateDate(2010, 10, 11);
    STAssertEquals(201010110000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}

- (void)testGenerateFromDate_December_31_9999
{
    NSDate *date = BTSCreateDate(9999, 12, 31);
    STAssertEquals(999912310000000000lu, [_generator generateFromDate:date], @"Generated Preferred Order Index");
}
...
- (void)testNilDateThrows
{
    ...
    @catch (NSException *exception) {
        ...
        STAssertEqualObjects(kBTSInvalidDate, [exception name], @"Exception Name.");
        STAssertEqualObjects(@"date is nil", [exception reason], @"Exception reason.");
    }
}
